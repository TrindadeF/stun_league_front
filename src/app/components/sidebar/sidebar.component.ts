...
export class SidebarComponent {
  ...
  constructor(private router: Router,private cookie: CookieService, private req: RequestsService, private userService: UserService) {}
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.req.get<PointResultDTO>("v1/points/" + this.username)
    .subscribe((data: PointResultDTO) => {
